        ...
        <div class = " modal-body center"  >
            <form action="?agregaEmpresa=registrar" method="POST" >                
                ...
                <div class="form-group">
                    ...
                    <input id="telefono" name="telefono" style=" height: 30px; width: 250px;" type="Text" >
                    <br/>
                </div>
                <div class="form-group">
                    <label style="font-size: 20px; display: inline-table;" for="direccion" >Dirección:&nbsp;</label>
                    <input id="direccion" name="direccion" style=" height: 30px; width: 250px;" type="text" >
                    <br/>                  
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input id="costo" name="costo" style=" height: 30px; width: 250px;" type="number" min="1" max="2500" >
                    <br/>                  
                </div>
                <div class="form-group">
                    <label style="font-size: 20px; display: inline-table;" for="puntuacion" >Puntuación :&nbsp;</label>
                    <input id="puntuacion" name="puntuacion" style=" height: 30px; width: 250px;" type="number" min="1" max="5" >
                    <br/>                  
                </div>
                <br>
                <br>
                <div class = "center">
                    <button class="find1" style=" line-height: 30px; margin: 10px; " type="submit">Agregar</button>
