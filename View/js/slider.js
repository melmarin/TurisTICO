...
var $elementPrice = $('input[id="Precio"]');
var $handlePrice;
...
$elementPrice
  .rangeslider({
    polyfill: false,
    onInit: function() {
      $handlePrice = $('.rangeslider__handle', this.$range);
      updateHandlePrice($handlePrice[0], this.value);
    }
  })
  .on('input', function() {
    updateHandlePrice($handlePrice[0], this.value);
...
function updateHandlePrice(el, val) {
  el.textContent = " " + "$" + val + " ";
}


var $elementDistance = $('input[id="Distancia"]');
var $handleDistance;
...
$elementDistance
  .rangeslider({
    polyfill: false,
    onInit: function() {
      $handleDistance = $('.rangeslider__handle', this.$range);
      updateHandleDistance($handleDistance[0], this.value);
    }
  })
  .on('input', function() {
    updateHandleDistance($handleDistance[0], this.value);
...
function updateHandleDistance(el, val) {
  el.textContent = " " + "Km " + val + " ";
}
